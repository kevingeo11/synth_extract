...
#SBATCH --job-name=elsevier-xml-to-md-dev
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
DB_PATH="$PROJECT_DIR/data/development_set/elsevier_track.db"
...
for required_path in \
    ...
    "$DB_PATH" \
    "$FULLTEXT_ROOT" \
    "$PROJECT_DIR/scripts/process/elsevier_xml_to_md.py"; do
...
echo "============================================================"
echo "Elsevier development-set XML-to-Markdown conversion"
echo "============================================================"
