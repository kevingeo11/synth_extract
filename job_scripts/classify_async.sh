...
#SBATCH --job-name=paper-classify-async
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "============================================================"
echo "Asynchronous paper classification"
echo "============================================================"
...
# Gemma configuration. For Qwen, add the appropriate reasoning-parser option.
...
echo
echo "Starting asynchronous classification"
python scripts/classify_papers_async.py "${CLASSIFIER_ARGS[@]}"

echo
echo "Asynchronous classification completed successfully at $(date)"
