...
#SBATCH --job-name=europepmc-xml-to-md-dev
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
DB_PATH="$PROJECT_DIR/data/development_set/europepmc_track.db"
...
for required_path in \
    ...
    "$DB_PATH" \
    "$FULLTEXT_ROOT" \
    "$PROJECT_DIR/scripts/process/europepmc_xml_to_md.py"; do
...
echo "============================================================"
echo "Europe PMC development-set XML-to-Markdown conversion"
echo "============================================================"
