#!/usr/bin/env python3
"""Convert Elsevier XML files in a tracking database to Markdown.
...
Usage
-----
    python scripts/process/elsevier_xml_to_md.py \
        --db data/process/elsevier_track.db \
...
LOG = logging.getLogger("elsevier_xml_to_md")
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Convert pending Elsevier XML files from a tracking SQLite "
        ...
        for row in pending_rows:
            ...
            if (
                ...
                if conversion_function is None:
                    from synth_extract.mining.process.elsevier_xml import (
                        elsevier_xml_to_markdown,
                    )

                    conversion_function = elsevier_xml_to_markdown
